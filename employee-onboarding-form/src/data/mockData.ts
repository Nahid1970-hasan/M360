...
export const skillsByDepartment = {
  Engineering: [
    ...
    'CI/CD', 'Microservices', 'Unit Testing', 'AWS', 'Azure', 'Kubernetes'
  ],
  Marketing: [
    'SEO', 'Content Writing', 'Google Ads', 'Social Media Marketing',
    'Email Marketing', 'Brand Management', 'Copywriting', 'Video Editing', 'Analytics', 'CRM'
  ],
  Sales: [
    'CRM Software', 'Lead Generation', 'Cold Calling', 'Upselling',
    'Negotiation', 'Client Relationship Management', 'B2B Sales', 'Territory Management', 'Salesforce', 'Forecasting'
  ],
  HR: [
    'Recruitment', 'Onboarding', 'Conflict Resolution', 'Payroll Management',
    'Compliance', 'Employee Training', 'Performance Review', 'HRIS', 'Benefits Administration'
  ],
  Finance: [
    'Budgeting', 'Financial Analysis', 'Accounting', 'Bookkeeping',
    'Payroll Processing', 'Tax Compliance', 'Expense Reporting', 'Cash Flow Management', 'Auditing', 'Investments'
  ],
};